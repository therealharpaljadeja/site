export const JavaScriptLogo: React.FC<JSX.IntrinsicElements["svg"]> = ({
    className,
    ...rest
}) => {
    return (
...
export const PythonLogo: React.FC<JSX.IntrinsicElements["svg"]> = ({
    className,
    ...rest
}) => {
    return (
...
export const ReactLogo: React.FC<JSX.IntrinsicElements["svg"]> = ({
    className,
    ...rest
}) => {
    return (
...
export const SolidityLogo: React.FC<JSX.IntrinsicElements["svg"]> = ({
    className,
    ...rest
}) => {
    return (
        ...
        >
            ...
            <path
                d="M14.517 1 10.98 7.286H3.912L7.446 1h7.07"
                fill="currentColor"
            />
            <path
                d="M10.98 7.286h7.07L14.518 1H7.446l3.534 6.286z"
                fill="currentColor"
            />
            <path
...
export const TypeScriptLogo: React.FC<JSX.IntrinsicElements["svg"]> = ({
    className,
    ...rest
}) => {
    return (
