<Header slug="cbsw-connect-wallet-tutorial" />
...
```ts showLineNumbers={true} fileName="wagmi.ts" filePath="src/wagmi.ts"
...
```tsx showLineNumbers={true} fileName="CoinbaseWalletLogo.tsx" filePath="src/components/CoinbaseWalletLogo.tsx"
...
```tsx showLineNumbers={true} fileName="CoinbaseButton.tsx" filePath="src/components/CoinbaseButton.tsx"
...
```tsx showLineNumbers={true} fileName="page.tsx" filePath="src/app/page.tsx"
